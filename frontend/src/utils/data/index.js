...
export const CardData = [
  {
    id: 1,
    cardHead: "YOU POSE WE COUNT",
    description:
      "Engulf your mind and body in yoga poses and we will tell you how long you held!",
    image: "../../time.png",
  },
  {
    id: 2,
    cardHead: "YOU PRACTICE. WE EXPLAIN.",
    description:
      "Practice various Yoga poses under our guidance and know its benefit and caution information too.",
    image: "../../accuracy.png",
  },
  {
    id: 3,
    cardHead: "GLOBAL DASHBOARD",
    description:
      "Your Best Pose duration will be compared with the global practioner and will be rewarded too.",
    image: "../../reward.png",
  },
];
